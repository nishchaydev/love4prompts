...
export const mockPrompts = [
  {
    ...
    "style": "Photography",
    "model": "Gemini",
    "image_url": "/images/trends/streetwear_editorial.png",
    "view_count": 1205,
    "save_count": 340,
    "category": "Boys",
    "subcategory": "Sigma",
  ...
  },
  {
    ...
    "style": "Various",
    "model": "ChatGPT",
    "image_url": "/images/trends/couple_lockscreen.png",
    "view_count": 505,
    "save_count": 54,
    "creator": null
  },
  ...
  },
  {
    ...
    "style": "Various",
    "model": "ChatGPT",
    "image_url": "/images/trends/birthday_chibi.png",
    "view_count": 357,
    "save_count": 29,
    "creator": null
  },
  ...
  },
  {
    ...
    "style": "Various",
    "model": "ChatGPT",
    "image_url": "/images/trends/neon_ghost_portrait.png",
    "view_count": 406,
    "save_count": 49,
    "creator": null
  },
...
// Apply deterministic creators to the prompts without one
mockPrompts.forEach((p, index) => {
  if (!p.creator) {
    const key = p.id || String(index);
    let hash = 0;
    for (let i = 0; i < key.length; i++) {
      hash = (hash << 5) - hash + key.charCodeAt(i);
      hash |= 0; // Convert to 32bit integer
    }
    const creatorIndex = Math.abs(hash) % creators.length;
    p.creator = creators[creatorIndex];
  }
});
